  ...
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/inventories">
        <icon name="users" class="mr-2 w-4 h-4" :class="isUrl('stocks') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('stocks') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Stocks</div>
      </Link>
    </div>

    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/orders">
        <icon name="users" class="mr-2 w-4 h-4" :class="isUrl('orders') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('orders') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Orders</div>
      </Link>
    </div>

        <div class="mb-4">
      <Link class="group flex items-center py-3" href="/shops">
        <icon name="users" class="mr-2 w-4 h-4" :class="isUrl('shops') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('shops') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Shops</div>
      </Link>
    </div>

    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/settings">
        <icon name="users" class="mr-2 w-4 h-4" :class="isUrl('settings') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />

    ...
    <div class="md:flex md:flex-col">
      ...
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:flex-shrink-0">
          ...
          <div class="flex items-center justify-between px-6 py-4 bg-indigo-800 md:flex-shrink-0 md:justify-center md:w-56">
                ...
                <template #default>
                    ...
                    <!-- End of Hamberger Icon -->

                <!-- Hamnurger drop down menu -->
                <template #dropdown>
                    <div class="mt-2 px-8 py-4 bg-indigo-900 rounded shadow-lg">
                    <main-menu />
                    </div>
                </template>
                <!-- End of Main Menu Tamplate -->
                </dropdown>
            </div>

          <div class="md:text-md flex items-end justify-between p-4 w-full text-sm bg-white border-b md:px-12 md:py-0">
